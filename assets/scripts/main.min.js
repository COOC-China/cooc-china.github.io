...
$(function () {
    ...
    if ((navbarHeight + mainHeight + footerHeight) < windowHeight) {
        var minHeight = windowHeight - navbarHeight - footerHeight - 60;
        $("#main").css({
            minHeight:minHeight
        });
    }
...
$(document).ready(function () {
    ...
    $("#galleryBtn").click(function(){
        if($("#galleryBtn").attr('aria-expanded') == 'false'){
            ...
            $("#galleryBtn").html('收起&nbsp;<i class="fa fa-angle-double-down"></i>');
        }
        else {
            $("#thumbs").animate({
                height:'190px'
            ...
            $("#galleryBtn").html('展开&nbsp;<i class="fa fa-angle-double-right"></i>');
        }
    });
});
